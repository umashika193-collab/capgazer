...
export const currentInflowSectorsData: CurrentInflowSector[] = [
  ...
  },
  {
    ...
    inflowAmountEn: "$131.5B / Quarter",
    inflowGrowth: "+54% YoY",
    inflowGrowthEn: "+54% YoY",
    growthNum: 54,
    shareRatio: 19,
  ...
  },
  {
    ...
    inflowAmount: "$109 億 / 四半期",
    inflowAmountEn: "$109.2B / Quarter",
    inflowGrowth: "+34% YoY",
