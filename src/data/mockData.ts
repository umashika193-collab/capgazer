...
export const currentInflowSectorsData: CurrentInflowSector[] = [
  {
    ...
    inflowAmount: "$191 億 / 四半期",
    inflowAmountEn: "$190.7B / Quarter",
    inflowGrowth: "+24% YoY",
  ...
  },
  {
    ...
    inflowAmountEn: "$130.2B / Quarter",
    inflowGrowth: "+52% YoY",
    inflowGrowthEn: "+52% YoY",
    growthNum: 52,
    shareRatio: 19,
...
export const trackerItemsData: TrackerItem[] = [
  {
    ...
    summary: [
      "米SEC EDGARに提出された公式文書（Form 6-K）を検知。公的提出日: 2026-09-24。",
      "資本市場および機関投資家向けに開示された法定報告書原本へのアクセスを即時同期。",
      "市場への重大な影響を持つ重要事項・資本異動に関する最新ファクトチェックを反映。"
    ],
    summaryEn: [
      "Verified official regulatory submission (Form 6-K) via SEC EDGAR. Filing Date: 2026-09-24.",
